...
class ControllerCatalogCategory extends Controller { 
	...
	private function getForm() {
		...
		if (isset($this->request->post['image_banner'])) {
			$this->data['image_banner'] = $this->request->post['image_banner'];
		} elseif (!empty($category_info)) {
			$this->data['image_banner'] = $category_info['image_banner'];
		} else {
			$this->data['image_banner'] = '';
		}
        
		if (isset($this->request->post['image_banner']) && file_exists(DIR_IMAGE . $this->request->post['image_banner'])) {
			$this->data['thumb_banner'] = $this->model_tool_image->resize($this->request->post['image_banner'], 100, 100);
		} elseif (!empty($category_info) && $category_info['image_banner'] && file_exists(DIR_IMAGE . $category_info['image_banner'])) {
			$this->data['thumb_banner'] = $this->model_tool_image->resize($category_info['image_banner'], 100, 100);
		} else {
			$this->data['thumb_banner'] = $this->model_tool_image->resize('no_image.jpg', 100, 100);
		}
