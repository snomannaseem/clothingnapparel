...
class ControllerCatalogProduct extends Controller {
	private $error = array(); 
  	...
  	private function getForm() {
		...
		$this->data['entry_sku_no'] = $this->language->get('entry_sku_no');
		$this->data['entry_sku_color'] = $this->language->get('entry_sku_color');
		$this->data['entry_sku_size'] = $this->language->get('entry_sku_size');
        ...
        $this->data['button_add_sku'] = $this->language->get('button_add_sku');
        ...
        // loading all colors
        $this->data['color_options'] = $this->model_catalog_option->getAllColorOptions($this->request->get['product_id']);			
        // loading all sizes
        $this->data['size_options']  = $this->model_catalog_option->getAllSizeOptions($this->request->get['product_id']);
        
        // loading product related child skus
        $this->data['product_skus']  = $this->model_catalog_product->getProductSkus($this->request->get['product_id']);
