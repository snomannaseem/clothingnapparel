          ...
          <table class="form">
            ...
            <tr>
              ...
              <td valign="top"><div class="image"><img src="<?php echo $thumb_banner; ?>" alt="" id="thumb_banner" />
                <input type="hidden" name="image_banner" value="<?php echo $image_banner; ?>" id="image_banner" />
                <br /><a onclick="image_upload('image_banner', 'thumb_banner');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb_banner').attr('src', '<?php echo $no_image; ?>'); $('#image_banner').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
            </tr>
            <tr>
