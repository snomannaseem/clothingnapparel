...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a>
      <a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-skus"><?php echo "SKUs"; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-image">
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                <td class="center">
                <select name="product_image[<?php echo $image_row; ?>][color_id]">
                    <?php foreach ($color_options as $color_option) { ?>
                    <?php if ($color_option['color_id'] == $product_image['color_id']) { ?>
                        <option value="<?php echo $color_option['color_id']; ?>" selected="selected"><?php echo $color_option['color_name']; ?></option>
                    <?php } else { ?>
                        <option value="<?php echo $color_option['color_id']; ?>"><?php echo $color_option['color_name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </td>
        ...
        <div id="tab-skus">
          <table id="skus" class="list">
            <thead>
              <tr>
                <td class="left">
                <?php echo $entry_sku_no; ?>
                </td>
                <td class="left">
                <?php echo $entry_sku_color; ?>
                </td>
                <td class="left">
                <?php echo $entry_sku_size; ?>
                </td>
                <td></td>
              </tr>
            </thead>
            ...
            <tbody id="sku-row<?php echo $sku_row; ?>">
              <tr>
              <td class="left"><input type="text" name="product_skus[<?php echo $sku_row; ?>][sku_no]" value="<?php echo $product_sku['sku_no']; ?>" size="30" /></td>
                <td class="left">
                <select name="product_skus[<?php echo $sku_row; ?>][color_id]">
                    <?php foreach ($color_options as $color_option) { ?>
                    <?php if ($color_option['color_id'] == $product_sku['color_id']) { ?>
                        <option value="<?php echo $color_option['color_id']; ?>" selected="selected"><?php echo $color_option['color_name']; ?></option>
                    <?php } else { ?>
                        <option value="<?php echo $color_option['color_id']; ?>"><?php echo $color_option['color_name']; ?></option>
                    <?php } ?>
                ...
                <td class="left">
                <select name="product_skus[<?php echo $sku_row; ?>][size_id]">
                    <?php foreach ($size_options as $size_option) {
                            if ($size_option['size_id'] == $product_sku['size_id']) { ?>
                            <option value="<?php echo $size_option['size_id']; ?>" selected="selected"><?php echo $size_option['size_name']; ?></option>
                    <?php } else { ?>
                        <option value="<?php echo $size_option['size_id']; ?>"><?php echo $size_option['size_name']; ?></option>
                    <?php } 
                        } 
                    ?>
                  </select></td>
                <td class="left"><a onclick="$('#sku-row<?php echo $sku_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $sku_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td colspan="3"></td>
                <td class="left"><a onclick="addSkus();" class="button"><?php echo $button_add_sku; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
...
function addImage() {
	...
	html += '  <tr>';
    html += '   <td class="center"><select name="product_image[<?php echo $image_row; ?>][color_id]"><?php foreach ($color_options as $color_option) { ?><?php if ($color_option['color_id'] == $product_image['color_id']) { ?><option value="<?php echo $color_option['color_id']; ?>" selected="selected"><?php echo $color_option['color_name']; ?></option><?php } else { ?><option value="<?php echo $color_option['color_id']; ?>"><?php echo $color_option['color_name']; ?></option><?php } } ?></select></td>';
...
<script type="text/javascript"><!--
var sku_row = <?php echo $sku_row; ?>;


function addSkus() {
	html  = '<tbody id="sku-row' + sku_row + '">';
	html += '  <tr>'; 
    html += '    <td class="left"><input type="text" name="product_skus[' + sku_row + '][sku_no]" value="" size="30" /></td>';    
    html += '    <td class="left"><select name="product_skus[' + sku_row + '][color_id]">';
    <?php foreach ($color_options as $color_option) { ?>
    html += '      <option value="<?php echo $color_option['color_id']; ?>"><?php echo $color_option['color_name']; ?></option>';
    <?php } ?>
    html += '    </select></td>';
    
    html += '    <td class="left"><select name="product_skus[' + sku_row + '][size_id]">';
    <?php foreach ($size_options as $size_option) { ?>
    html += '      <option value="<?php echo $size_option['size_id']; ?>"><?php echo $size_option['size_name']; ?></option>';
    <?php } ?>
    html += '    </select></td>';    
    
	html += '    <td class="left"><a onclick="$(\'#sku-row' + sku_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
    html += '</tbody>';
	
	$('#skus tfoot').before(html);
