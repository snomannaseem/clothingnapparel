...
<div id="container">
    ...
    <div id="menu">
        <ul>
        	...
        	<li><a href="<?php echo $category['href']; ?>"><?php echo ucwords($category['name']); ?></a>
        	...
        	<div>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $category['children'][$i]['href']; ?>"><?php echo ucwords($category['children'][$i]['name']); ?></a></li>
                    <?php } ?>
                    <?php } ?>
                </ul>
            	<?php } ?>
