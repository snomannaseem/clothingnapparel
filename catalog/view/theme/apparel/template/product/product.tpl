...
<div id="content" class="inside_page">
	...
	<div class="product-info">  
		...
		<div class="right"> 
								...
								<div id="detail_color" class="left">						
									<?php foreach ($option['option_value'] as $option_value) { ?>
										<?php if (!empty($option_value['op_desc1'])) {?>
											<div product_option_id="option[<?php echo $option['product_option_id']; ?>]" option_value="<?php echo $option_value['product_option_value_id']; ?>"  style="background-color:<?php echo $option_value['op_desc1']; ?>" class="shoe_color getImages" color_id="<?php echo $option_value['option_value_id']; ?>" product_id="<?php echo $product_id; ?>" >
											</div>
										<?php } ?>
									<?php } ?>
								</div>              
			...
			<div class="cart">
				...
				<a onclick="addToWishList('<?php echo $product_id; ?>');" class="icon_plus wishlist_link">
	...
	<?php if ($review_status) { ?>
		<div id="tab-review" class="tab-content">
			...
			<input type="text" name="captcha" value=""  class='ie_left'/><br />
