...
<div id="content"><?php echo $content_top; ?>
	...
	<div class="product-info">
        ...
        <div class="right">
            ...
            <div class="options">
                ...
                <?php foreach ($options as $option) { ?>
                    ...
                    <?php if ($option['type'] == 'select') { ?>
                        <div class="size" id="option-<?php echo $option['product_option_id']; ?>" class="option">
            ...
            <div class="review">
                <div>
                    <img src="catalog/view/theme/shoes/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
                    &nbsp;&nbsp;(<a onclick="$('a[href=\'#tab-review\']').trigger('click');" class='rev_count'><?php echo $reviews; ?></a>)
                    &nbsp;&nbsp;&nbsp;<span class="divider">|</span>
                    &nbsp;&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');" class="icon_plus"><?php echo $text_write; ?></a>
                </div>
