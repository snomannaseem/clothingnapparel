...
<div id="content" class="inside_page">
                ...
                <?php if ($thumb) { ?>
                    <div class="image">
                        <div class="image_inside">
                            <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class = 'cloud-zoom' id='zoom1' rel="tint: '#ffffff',tintOpacity:0.5 ,smoothMove:3,zoomWidth:520, zoomHeight:500, adjustY:-10, adjustX:28">
    ...
    <div class="right"> 
      ...
      <div class="description">
        ...
        <span>SKU Number</span>&nbsp; <?php echo $sku; ?><br />
        <?php if ($reward) { ?>
      ...
      ?>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option"></div>
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <select id= "opt_<?php echo strtolower($option['name']) ?>"  name="option[<?php echo $option['product_option_id']; ?>]">
    ...
    $('.getImages').click( function() {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $("#image").attr('class','thumb_loading');
            },
            complete: function() {
                is_processing = false;
